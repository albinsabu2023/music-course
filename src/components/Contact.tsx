...
function Contact() {
  ...
  return (
    <div id="contact" className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black min-h-screen flex flex-col justify-center align-center">
      ...
      <div className=" flex p-2 m-2 items-center justify-center">
        <Link href={"https://github.com/albinsabu2023"} className="p-2 rounded-full hover:bg-cyan-500">
            <IconBrandGithub  />     
        </Link>
        <Link href={"https://www.linkedin.com/in/albin-sabu2023/"} className="p-2 rounded-full hover:bg-cyan-500">
            <IconBrandLinkedin/>
        </Link>
        <Link href={"mailto:albinsullas13@gmail.com?" } className="p-2 rounded-full hover:bg-cyan-500">
            <IconBrandGmail/>
        </Link>
        
      </div>
       
      <p className="text-cyan-400   font-small">2024 India kerala,All Right Reserved  &#169;  Albin Sabu</p>
      </div>
